              ...
              try {
                ...
                t.state !== x &&
                  ...
                  (t.type == Q || (t.data && t.data.isPeriodic)
                    ...
                    : ((t.runCount = 0), this._updateTaskCount(t, -1), C && t._transitionTo(x, p, x))),
                  (U = U.parent),
                  (re = $);
              }
            }
        ...
        class v {
          constructor(E, t, r) {
            ...
            (k || (t && t._hasTaskZS)) &&
              ...
              r.onScheduleTask ||
                ((this._scheduleTaskZS = P), (this._scheduleTaskDlgt = t), (this._scheduleTaskCurrZone = this.zone)),
              r.onInvokeTask ||
                ((this._invokeTaskZS = P), (this._invokeTaskDlgt = t), (this._invokeTaskCurrZone = this.zone)),
              r.onCancelTask ||
                ((this._cancelTaskZS = P), (this._cancelTaskDlgt = t), (this._cancelTaskCurrZone = this.zone)));
          }
          fork(E, t) {
          ...
          invokeTask(E, t, r, k) {
            return this._invokeTaskZS
              ? this._invokeTaskZS.onInvokeTask(this._invokeTaskDlgt, this._invokeTaskCurrZone, E, t, r, k)
            ...
            (function (c) {
              'function' == typeof i[c]
                ...
                : Ee(Y[e].prototype, c, {
                    set: function (a) {
                      'function' == typeof a
                        ? ((this[ne][c] = Ie(a, e + '.' + c)), ue(this[ne][c], a))
                        : (this[ne][c] = a);
                    },
                    get: function () {
                      return this[ne][c];
        ...
        function z(l, u, s) {
          ...
          if (l[q] === j) {
            ...
            if (u !== G && s instanceof t && s.hasOwnProperty(q) && s.hasOwnProperty(R) && s[q] !== j)
              ...
              const b = l[R];
              if (
                ((l[R] = s), l[_] === _ && u === p && ((l[q] = l[x]), (l[R] = l[K])), u === G && s instanceof Error)
              ) {
                    ...
                    if (b)
                      for (let T = 0; T < b.length; T++)
                        if (b[T] === s) {
                          b.splice(T, 1),
                            (s.isRemoved = !0),
                            0 === b.length && ((s.allRemoved = !0), (s.target[g] = null));
                          break;
                        }
                  }
                ...
                for (let V = 0; V < S.length; V++) {
                  ...
                  if (C(F, T))
                    return (
                      ...
                      (F.isRemoved = !0),
                      0 === S.length &&
                        ((F.allRemoved = !0), (s[O] = null), 'string' == typeof f) &&
              ...
              c.forEach(function (m) {
                ...
                try {
                  if (Z.hasOwnProperty(m)) {
                    ...
                    N && N.value
                      ? ((N.value = e.wrapWithCurrentZone(N.value, L)), e._redefineProperty(P.prototype, m, N))
              ...
              if ('function' == typeof L[0]) {
                ...
                L[0] = function () {
                  try {
                    ...
                    Z.isPeriodic ||
                      ('number' == typeof Z.handleId ? delete y[Z.handleId] : Z.handleId && (Z.handleId[Ce] = null));
                  }
                };
          ...
          (a = le(
            ...
            v =>
              function (m, L) {
                const Z = L[0];
                let N;
                'number' == typeof Z ? (N = y[Z]) : ((N = Z && Z[Ce]), N || (N = Z)),
                  N && 'string' == typeof N.type
                    ? 'notScheduled' !== N.state &&
                      ((N.cancelFn && N.data.isPeriodic) || 0 === N.runCount) &&
                      ('number' == typeof Z ? delete y[Z] : Z && (Z[Ce] = null), N.zone.cancelTask(N))
                    : v.apply(e, L);
              }
          ));
      }
              ...
              p = le(
                ...
                () =>
                  function (h, I) {
                    ...
                    {
                      const w = { target: h, url: h[y], isPeriodic: !1, args: I, aborted: !1 },
